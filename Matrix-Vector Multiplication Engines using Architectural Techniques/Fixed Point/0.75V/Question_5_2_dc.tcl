...
source "/afs/asu.edu/users/s/j/p/sjparekh/asap7_sagar/FPGA/HW2/DC_setup_28nm_0p75v.setup"
set hdlin_vrlg_std "2001"
# Read in the Synphony design verilog or vhdl
analyze -format verilog { SynLib.v}
analyze -format verilog Question_5_2.v


elaborate Question_5_2
...
#link 
#check_design > Question_5_2_check_design.log
