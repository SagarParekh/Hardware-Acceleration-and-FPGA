...
Assuming 𝑨 ∈ ℝ^(64×64) is a square matrix with 64 rows and columns, respectively, and 𝑥 ∈ ℝ^64 is a 64 dimensional vector,the multiplication of 𝑦𝑦=𝑨𝑨𝑥𝑥 can be computed in a column-wise fashion.
